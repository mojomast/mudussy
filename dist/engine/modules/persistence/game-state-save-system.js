...
exports.GameStateSaveSystem = void 0;
...
class GameStateSaveSystem extends events_1.EventEmitter {
    ...
    async save(data, type, description) {
        if (type !== types_1.SaveType.GAME_STATE && type !== types_1.SaveType.FULL) {
        ...
        try {
            ...
            this.eventSystem.emit(new event_1.GameEvent(types_1.PersistenceEventTypes.SAVE_COMPLETED, 'game-state-save-system', saveId, { type, path: savePath, description }));
            return saveId;
        }
        catch (error) {
    ...
    async load(saveId) {
        ...
        try {
            ...
            const gameStateData = saveFile.data;
            ...
            this.eventSystem.emit(new event_1.GameEvent(types_1.PersistenceEventTypes.LOAD_COMPLETED, 'game-state-save-system', saveId, { type: types_1.SaveType.GAME_STATE, path: savePath }));
    ...
    async saveGameState(saveId, description) {
        const gameStateData = {
            globalFlags: { ...this.globalFlags },
            factionRelations: this.deepClone(this.factionRelations),
            questProgress: this.deepClone(this.questProgress),
        ...
        return this.save(gameStateData, types_1.SaveType.GAME_STATE, description);
    }
    ...
    getFactionRelation(factionA, factionB) {
        return this.factionRelations[factionA]?.[factionB] || 0;
    }
    updateQuestProgress(questId, playerId, objective, completed) {
    ...
    scheduleEvent(type, scheduledTime, data, recurring, interval) {
    ...
    createSaveMetadata(saveId, type, description, gameStateData) {
        return {
            version: '1.0.0',
            timestamp: new Date(),
            gameVersion: '1.0.0',
    ...
    async createBackup(originalPath, reason) {
        try {
            ...
            this.eventSystem.emit(new event_1.GameEvent(types_1.PersistenceEventTypes.BACKUP_CREATED, 'game-state-save-system', (0, uuid_1.v4)(), backupInfo));
...
exports.GameStateSaveSystem = GameStateSaveSystem;
//# sourceMappingURL=game-state-save-system.js.map